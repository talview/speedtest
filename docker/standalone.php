...
<head>
	...
	<script type="text/javascript">
	  ...
	  let message = "";
      let prevTestState = null;
      let flag2 = false;
      let flag = false;
      let instructionsare = ` 
      <ul> 
  <strong>Improving Your Internet Connection Speed </strong>

 <li>Restart your router</li>
 <li> Connect to a different network</li>
<li> Check for any active VPNs or firewalls</li>
<li>Use a wired connection instead of Wi-Fi for better stability.</li>
<li> Put your router in a central location. Make sure that walls or other solid objects aren't blocking your Wi-Fi signal.</li>
...
<li> Make sure no one else is using the internet while you’re testing. Things like watching/ video streaming will slow down the connection.</li>
      ...
      function updateUI(forced) {
        ...
        if (status == 4) {
          if (prevTestState !== 4) ToShowStatus();
        }

        prevTestState = uiData.testState;
      }
      function oscillate() {
      ...
      function ToShowStatus() {
        ...
        if (!flag) {
          if (flag2) {
            message +=
              " Please check your connection settings and try again. For help, visit : <a href= https://talview.freshdesk.com/support/solutions/articles/11000129970-steps-to-perform-a-network-test target='_blank'>Talview.support.com</a> ";
          }
          document.querySelector("#instructions").innerHTML = instructionsare;
        }

        I("message").innerHTML = message;

        if (flag) I("message").classList.add("success");

        if (!flag) I("message").classList.add("alert-danger");
      }
      ...
      function clearmessage() {
        ...
        I("message").innerHTML = "";
        I("message").classList.remove("alert-danger");
      }
    </script>
