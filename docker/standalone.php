...
<head>
  ...
  <script type="text/javascript">
    ...
    function startStop() {
      ...
      I("slow-speed-error-instruction").innerHTML = "";
      ...
      if (s.getState() == 3) {
        ...
        I("statusMessage").innerHTML = "Test in progress...";
        I("statusMessage").classList.add("Loader");
    ...
    function ToShowStatus() {
      ...
      if (!flag) {
        ...
        document.querySelector("#slow-speed-error-instruction").innerHTML = slow_speed_instructions;
      }

      I("statusMessage").innerHTML = message;
